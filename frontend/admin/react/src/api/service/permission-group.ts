...
export async function createPermissionGroup(request: permissionservicev1_CreatePermissionGroupRequest) {
  return getPermissionGroupService().Create(request);
}

export async function updatePermissionGroup(request: permissionservicev1_UpdatePermissionGroupRequest) {
  return getPermissionGroupService().Update(request);
}

export async function deletePermissionGroup(request: permissionservicev1_DeletePermissionGroupRequest) {
