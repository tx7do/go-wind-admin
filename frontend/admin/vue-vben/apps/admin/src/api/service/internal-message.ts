...
let _messageInstance: null | ReturnType<
  typeof createInternalMessageServiceClient
> = null;
let _categoryInstance: null | ReturnType<
  typeof createInternalMessageCategoryServiceClient
> = null;
let _recipientInstance: null | ReturnType<
  typeof createInternalMessageRecipientServiceClient
> = null;
...
export function getMessageRecipientService() {
  if (!_recipientInstance) {
    _recipientInstance =
      createInternalMessageRecipientServiceClient(requestApi);
  }
