		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[2]},
			},
			{
				Name:    "apiauditlog_created_at",
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[1]},
			},
			{
				Name:    "apiauditlog_tenant_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[2], SysAPIAuditLogsColumns[1]},
			},
			{
				Name:    "apiauditlog_user_id",
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[3]},
			},
			{
				Name:    "apiauditlog_username",
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[4]},
			},
			{
				Name:    "apiauditlog_tenant_id_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[2], SysAPIAuditLogsColumns[3], SysAPIAuditLogsColumns[1]},
			},
			{
				Name:    "apiauditlog_ip_address",
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[5]},
			},
			{
				Name:    "apiauditlog_ip_address_created_at",
				Unique:  false,
				Columns: []*schema.Column{SysAPIAuditLogsColumns[5], SysAPIAuditLogsColumns[1]},
			},
			{
