...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	v := server.NewRestMiddleware(context, accessTokenChecker, tenantAccessChecker, authorizerAuthorizer, apiAuditLogRepo, loginAuditLogRepo, operationAuditLogRepo, permissionAuditLogRepo, dataAccessAuditLogRepo, policyEvaluationLogRepo)
	...
	auditLogArchiveRepo := data.NewAuditLogArchiveRepo(context, entClient)
	minIOClient := data.NewMinIoClient(context)
	taskService := service.NewTaskService(context, taskRepo, userRepo, backupRepo, tenantUsageRepo, auditLogArchiveRepo, minIOClient)
