...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	v := server.NewRestMiddleware(context, accessTokenChecker, tenantAccessChecker, authorizerAuthorizer, apiAuditLogRepo, loginAuditLogRepo, operationAuditLogRepo, permissionAuditLogRepo, dataAccessAuditLogRepo)
