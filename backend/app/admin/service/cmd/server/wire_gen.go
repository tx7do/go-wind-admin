...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	authorizerProvider := data.NewAuthorizerProvider(context, roleRepo, apiResourceRepo)
	...
	permissionGroupService := service.NewPermissionGroupService(context, permissionGroupRepo)
