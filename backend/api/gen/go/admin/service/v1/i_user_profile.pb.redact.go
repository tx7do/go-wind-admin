...
// Unary RPC
func (s *redactedUserProfileServiceServer) ChangePassword(ctx context.Context, in *userpb.ChangePasswordRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserProfileServiceServer) UploadAvatar(ctx context.Context, in *userpb.UploadAvatarRequest) (*userpb.UploadAvatarResponse, error) {
...
// Unary RPC
func (s *redactedUserProfileServiceServer) BindContact(ctx context.Context, in *userpb.BindContactRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserProfileServiceServer) VerifyContact(ctx context.Context, in *userpb.VerifyContactRequest) (*emptypb.Empty, error) {
