...
func (x *AdminOperationLog) GetTenantId() uint32 {
...
func (x *AdminOperationLog) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *ListAdminOperationLogResponse) GetTotal() uint64 {
	if x != nil {
		return x.Total
	}
	return 0
...
type GetAdminOperationLogRequest struct {
	...
	//
	//	*GetAdminOperationLogRequest_Id
	QueryBy       isGetAdminOperationLogRequest_QueryBy `protobuf_oneof:"query_by"`
...
func (x *GetAdminOperationLogRequest) GetQueryBy() isGetAdminOperationLogRequest_QueryBy {
	if x != nil {
		return x.QueryBy
	}
	return nil
...
func (x *GetAdminOperationLogRequest) GetId() uint32 {
	if x != nil {
		if x, ok := x.QueryBy.(*GetAdminOperationLogRequest_Id); ok {
			return x.Id
		}
	}
	return 0
...
type isGetAdminOperationLogRequest_QueryBy interface {
	isGetAdminOperationLogRequest_QueryBy()
}

type GetAdminOperationLogRequest_Id struct {
	Id uint32 `protobuf:"varint,1,opt,name=id,proto3,oneof"` // ID
}

func (*GetAdminOperationLogRequest_Id) isGetAdminOperationLogRequest_QueryBy() {}
...
const file_admin_service_v1_i_admin_operation_log_proto_rawDesc = "" +
	...
	"\x1bGetAdminOperationLogRequest\x12\x1c\n" +
	...
	"\x04List\x12\x19.pagination.PagingRequest\x1a/.admin.service.v1.ListAdminOperationLogResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/admin/v1/admin-operation-logs\x12\x86\x01\n" +
	"\x03Get\x12-.admin.service.v1.GetAdminOperationLogRequest\x1a#.admin.service.v1.AdminOperationLog\"+\x82\xd3\xe4\x93\x02%\x12#/admin/v1/admin-operation-logs/{id}B\xc4\x01\n" +
	"\x14com.admin.service.v1B\x17IAdminOperationLogProtoP\x01Z1go-wind-admin/api/gen/go/admin/service/v1;adminpb\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"
...
func file_admin_service_v1_i_admin_operation_log_proto_init() {
	...
	file_admin_service_v1_i_admin_operation_log_proto_msgTypes[2].OneofWrappers = []any{
		(*GetAdminOperationLogRequest_Id)(nil),
	}
