...
type ApiResourceServiceClient interface {
	// 查询API资源列表
	List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListApiResourceResponse, error)
	// 查询API资源详情
	Get(ctx context.Context, in *v11.GetApiResourceRequest, opts ...grpc.CallOption) (*v11.ApiResource, error)
	// 创建API资源
	Create(ctx context.Context, in *v11.CreateApiResourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 更新API资源
	Update(ctx context.Context, in *v11.UpdateApiResourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 删除API资源
	Delete(ctx context.Context, in *v11.DeleteApiResourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 同步API资源
	SyncApiResources(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 查询路由数据
	GetWalkRouteData(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v11.ListApiResourceResponse, error)
}
...
func (c *apiResourceServiceClient) List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListApiResourceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.ListApiResourceResponse)
...
func (c *apiResourceServiceClient) Get(ctx context.Context, in *v11.GetApiResourceRequest, opts ...grpc.CallOption) (*v11.ApiResource, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.ApiResource)
...
func (c *apiResourceServiceClient) Create(ctx context.Context, in *v11.CreateApiResourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *apiResourceServiceClient) Update(ctx context.Context, in *v11.UpdateApiResourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *apiResourceServiceClient) Delete(ctx context.Context, in *v11.DeleteApiResourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *apiResourceServiceClient) GetWalkRouteData(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v11.ListApiResourceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.ListApiResourceResponse)
...
func (UnimplementedApiResourceServiceServer) List(context.Context, *v1.PagingRequest) (*v11.ListApiResourceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedApiResourceServiceServer) Get(context.Context, *v11.GetApiResourceRequest) (*v11.ApiResource, error) {
	return nil, status.Error(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedApiResourceServiceServer) Create(context.Context, *v11.CreateApiResourceRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedApiResourceServiceServer) Update(context.Context, *v11.UpdateApiResourceRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedApiResourceServiceServer) Delete(context.Context, *v11.DeleteApiResourceRequest) (*emptypb.Empty, error) {
...
func (UnimplementedApiResourceServiceServer) GetWalkRouteData(context.Context, *emptypb.Empty) (*v11.ListApiResourceResponse, error) {
...
func _ApiResourceService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.GetApiResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiResourceServiceServer).Get(ctx, req.(*v11.GetApiResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ApiResourceService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.CreateApiResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiResourceServiceServer).Create(ctx, req.(*v11.CreateApiResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ApiResourceService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.UpdateApiResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiResourceServiceServer).Update(ctx, req.(*v11.UpdateApiResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ApiResourceService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.DeleteApiResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiResourceServiceServer).Delete(ctx, req.(*v11.DeleteApiResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
