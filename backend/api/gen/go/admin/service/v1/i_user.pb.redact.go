...
// Unary RPC
func (s *redactedUserServiceServer) List(ctx context.Context, in *pagination.PagingRequest) (*userpb.ListUserResponse, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) Get(ctx context.Context, in *userpb.GetUserRequest) (*userpb.User, error) {
	if s.bypass.CheckInternal(ctx) {
...
// Unary RPC
func (s *redactedUserServiceServer) Create(ctx context.Context, in *userpb.CreateUserRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) Update(ctx context.Context, in *userpb.UpdateUserRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) Delete(ctx context.Context, in *userpb.DeleteUserRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) UserExists(ctx context.Context, in *userpb.UserExistsRequest) (*userpb.UserExistsResponse, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) EditUserPassword(ctx context.Context, in *userpb.EditUserPasswordRequest) (*emptypb.Empty, error) {
