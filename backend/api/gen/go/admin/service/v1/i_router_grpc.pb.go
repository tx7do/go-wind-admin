...
type RouterServiceClient interface {
	// 查询路由列表
	ListRoute(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.ListRouteResponse, error)
	// 查询权限码列表
	ListPermissionCode(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.ListPermissionCodeResponse, error)
}
...
func (c *routerServiceClient) ListRoute(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.ListRouteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.ListRouteResponse)
...
func (c *routerServiceClient) ListPermissionCode(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.ListPermissionCodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.ListPermissionCodeResponse)
...
func (UnimplementedRouterServiceServer) ListRoute(context.Context, *emptypb.Empty) (*v1.ListRouteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListRoute not implemented")
}
func (UnimplementedRouterServiceServer) ListPermissionCode(context.Context, *emptypb.Empty) (*v1.ListPermissionCodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListPermissionCode not implemented")
}
